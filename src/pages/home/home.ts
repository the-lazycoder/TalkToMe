...
export class HomePage {
  ...
  copyID(){
    this.clipboard.copy(this.myCallId);
    this.appService.showToast(this.myCallId+" is copied to clipboard.")
  }
  ...
  sessionReadyHandler(e) {
    ...
    this.myCallId=apiCC.session.apiCCId;
    this.infoLabel = "Your ID : "+this.myCallId;
  }
